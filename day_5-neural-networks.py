...
dataloader = DataLoader(dataset, batch_size=batch_size, shuffle=True)           # dataloaders batch and shuffle the dataset for us
...
for epoch in range(epochs):                                                         # how many times to go through whole dataset?
    for batch_idx, batch in enumerate(dataloader):                                  # for each minibatch from dataloader
        print(batch)
